...
export default function Main() {
  ...
  function scrollToCertificates() {
    document
      .querySelector("#certificates_overview")
      .scrollIntoView({ behavior: "smooth" });
  }
  return (
    <Container>
      <Heading1 ref={target.current[0]} margin="0 0 1.4rem 0">
        My <strong>educational</strong> path is characterized by a continuous
        <span> development</span> process
      </Heading1>
      <Text2 ref={target.current[1]}>
        I grasped most of my knowledge throughout the online media, consuming
        tons of articles, documentations, tutorials and courses. Some of my
        achievements I would like to highlight the most.
      </Text2>
      <ButtonPrimary
