...
export default function LandingPage(){
  ...
  return (
    <>
      ...
      <Parallax title='Customer Service' body='Just in case you face a problem, we are here to help you. You can call us from Monday till Friday between 9AM and 5PM' link='tel:0031682307051' btn='+31 682 30 70 51'/>
      <SocialMedia/>
    </>
  )
}
